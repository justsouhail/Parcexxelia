...
<form action="/Materiel/Reseau/traitement" method="post" enctype="multipart/form-data" >
    @csrf
       
        
    <div style="text-align: center; padding-bottom: 20px;"><h4 ><b>Ajouter un materiel reseau</b></h4></div>
...
<div class="col-4">
    ...
    <div class="form-group" >
      ...
      <input type="text" name="Addresse_MAC" class="form-control" id="Addresse_MAC" placeholder="Addresse_MAC" value="{{ old('Addresse_MAC') }}">
  ...
  <div class="col-4">
    <div class="form-group">
      ...
      <input type="text" name="Localisation" class="form-control" id="Localisation" placeholder="Localisation"  value="{{ old('Localisation') }}">
...
<div class="col-4">
    <div class="form-group ">
        ...
        <input type="text" name="Conf_Details" class="form-control @error('Conf_Details') is-invalid @enderror" id="Conf_Details" placeholder="Configuration" value="{{ old('Conf_Details') }}">
        @error('Conf_Details')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
